...
public class Dog {
    ...
    public enum breeds
    {
        Spaniel,Bulldog,Beagle;
    }
    public static void main(String args [])
    {
        Dog dog1 = new Dog("Max", 3,"Spaniel");
        Dog dog2 = new Dog("Rex", 1,"Bulldog");
        Dog dog3 = new Dog("Bob", 2,"Beagle");
        ...
        if(dog1.getAge()> dog2.getAge() && dog1.getAge()>dog3.getAge()) {
            max = dog1.getAge();
            System.out.println("The oldest dog's name is " + dog1.getName() + " and he is " + dog1.getBreed());
        }
        if (dog2.getAge()>dog3.getAge() && dog2.getAge()> dog1.getAge()) {
            max = dog2.getAge();
            System.out.println("The oldest dog's name is " + dog2.getName() + " and he is " + dog2.getName());
        }
        if (dog3.getAge()>dog1.getAge() && dog3.getAge()>dog2.getAge()) {
            max = dog3.getAge();
            System.out.println("The oldest dog's name is " + dog3.getName() + " and he is " + dog3.getBreed());
        }
    }
