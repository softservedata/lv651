...
public class ApplTime {
	public static void main(String[] args) {
		...
		*/
		...
		System.out.println("date3: " + date3 + "  Month.DECEMBER = " + Month.DECEMBER.getValue());
		//
		// 22 hour 15 minutes
		...
		*/
		/*-
		LocalDateTime a = LocalDateTime.of(2022, 2, 20, 12, 01);
		LocalDateTime t = a.with(TemporalAdjusters.firstDayOfMonth());
		System.out.println("TemporalAdjusters.firstDayOfMonth() = " + t);
		DayOfWeek dayweek = t.getDayOfWeek();
		System.out.println("firstDayOfMonth, dayweek = " + dayweek);
		//
		LocalDate currentDate = LocalDate.now();
		LocalDateTime currentDateTime = LocalDateTime.now();
		...
		*/
		...
		System.out.println("ofEpoch LocalDateTime = " + date);
		//
		//
		...
		LocalDateTime localDate = new Date(System.currentTimeMillis()).toInstant()
